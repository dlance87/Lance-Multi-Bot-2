...
async def save_thumb_nail(client, message):
    ...
    if message.reply_to_message is not None:
        ...
        await ismgs.edit(
            ...
            "This 🏞 image will be used or applied 📬 in the uploaded  content, until you clear it with this command /clearthumbnail ."
        )
    else:
...
async def clear_thumb_nail(client, message):
    ...
    await ismgs.edit("✅ Custom thumbnail cleared or deleted 🚮 succesfully.")
